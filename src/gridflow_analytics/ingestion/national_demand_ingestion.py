...
from gridflow_analytics.config.config import (BRONZE_CONTAINER,STORAGE_ACCOUNT,ENERGYMAP_NATIONAL_DEMAND_URL,ENERGYMAP_FETCH_HOURS)
...
def main():
    ...
    try:
        ...
        data = fetch_national_demand_data(dbutils=dbutils,hours=ENERGYMAP_FETCH_HOURS)
