...
def fetch_frequency_data(dbutils,from_timestamp: str,to_timestamp: str) -> dict:
...
def main():
    ...
    try:
        ...
        data = fetch_frequency_data(dbutils=dbutils,from_timestamp=from_timestamp,to_timestamp=to_timestamp)
