...
def main():
    ...
    try:
        ...
        col("point.dewpoint_2m").cast("double").alias("dewpoint"),col("point.wind_speed_10m").cast("double").alias("wind_speed"),col("point.wind_direction_10m").cast("double").alias("wind_direction"),
        col("point.surface_pressure").cast("double").alias("surface_pressure"),col("point.cloud_cover").cast("double").alias("cloud_cover"),
        col("point.precipitation").cast("double").alias("precipitation"),col("point.ghi_w_m2").cast("double").alias("ghi"),col("point.direct_radiation").cast("double").alias("direct_radiation"),
        col("point.dni_w_m2").cast("double").alias("dni"),col("point.dhi_w_m2").cast("double").alias("dhi"),col("ingestion_timestamp"))
